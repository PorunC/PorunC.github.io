...
> |  |  |
> | --- | --- |
> | ``` 1 ``` | ``` >git clone git://github.com/mit-pdos/xv6-riscv.git ``` |
>
> and
>
> |  |  |
> | --- | --- |
> | ``` 1 ``` | ``` >git clone git://github.com/mit-pdos/xv6-riscv-book.git ``` |
