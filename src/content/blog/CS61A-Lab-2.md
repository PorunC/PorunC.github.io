---
title: CS61A Lab 2
date: '2022-05-19T11:07:23.000Z'
updated: '2022-05-19T11:16:42.000Z'
tags:
  - CS61A
categories: []
slug: 2022/05/19/CS61A-Lab-2
oldUrl: /2022/05/19/CS61A-Lab-2/
excerpt: >-
  We can transform multiple argument functions into a chain of single argument,
  higher order functions. For example, we can write a function f(x, y) as a
  different function g(x)(y). ...
---
### Currying
...
def digit_index_factory(num, k):
    ...
    def digit_index_factory(num, k):1
        index = 0
        while num:
            if num % 10 == k:
                return lambda: index
