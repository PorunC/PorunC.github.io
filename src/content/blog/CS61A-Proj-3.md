---
title: CS61A Proj 3
date: '2022-05-23T09:05:24.000Z'
updated: '2022-05-23T12:44:28.000Z'
tags:
  - CS61A
categories: []
slug: 2022/05/23/CS61A-Proj-3
oldUrl: /2022/05/23/CS61A-Proj-3/
excerpt: >-
  The bees are coming! Create a better soldier With inherit ants. Important
  submission note : For full credit, Submit with Phase 1 complete by Thursday,
  March 3 (worth 1 pt). Submit ...
---
# Project 3: Ants Vs. SomeBees [ants.zip](https://cs61a.org/proj/ants/ants.zip)

![Ants vs. Somebees](https://cs61a.org/proj/ants/assets/splash.png)
...
- `state.py`: Abstraction for gamestate for [gui.py](http://gui.py)
...
![img](https://cs61a.org/proj/ants/img/gui_explanation.png)
...
> To see these videos, you should be logged into your [berkeley.edu](http://berkeley.edu) email.
