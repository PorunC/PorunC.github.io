---
title: Wireshark-Lab2 HTTP
date: '2022-03-02T08:31:28.000Z'
updated: '2023-02-22T13:07:14.000Z'
tags:
  - Network
  - Wireshark
categories: []
slug: 2022/03/02/Wireshark-Lab2
oldUrl: /2022/03/02/Wireshark-Lab2/
excerpt: >-
  在介Wireshark实验
  入门里，我们已经初步使用了Wireshark包嗅探器，我们现在可以操作Wireshark来查看网络协议。在这个实验中，我们会探索HTTP协议的几个方面：基本的GET/response交互，HTTP消息格式，检索大型HTML文件，检索具有嵌入对象的HTML文件，HTTP认证和安全性。在开始这些实验之前，您可能想查看书中第2.2节。
  ...
---
# Lab2:HTTP
...
1. 您的浏览器是否运行HTTP版本1.0或1.1？服务器运行什么版本的HTTP？
   - 浏览器和服务器的HTTP版本都是1.1。
   - ![](https://img-blog.csdnimg.cn/98e463c78c224872b81826b643201827.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBATUlOR2dvUw==,size_20,color_FFFFFF,t_70,g_se,x_16)
2. 您的浏览器会从接服务器接受哪种语言（如果有的话）？
   - en-US, zh-CN
   - ![](https://img-blog.csdnimg.cn/aca48d5cd51349f0a7bf8d83d9b0262a.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBATUlOR2dvUw==,size_20,color_FFFFFF,t_70,g_se,x_16)
...
5. 服务器上HTML文件的最近一次修改是什么时候？
   - Thu, 03 Mar 2022 06:59:01 GMT
6. 服务器返回多少字节的内容到您的浏览器？
   - 128
   - ![](https://img-blog.csdnimg.cn/ae9c9a534cec42058f2f2d1298fb63df.png)
...
8. 检查第一个从您浏览器到服务器的HTTP GET请求的内容。您在HTTP GET中看到了“IF-MODIFIED-SINCE”行吗？
   ...
   - ![](https://img-blog.csdnimg.cn/590fa5c40e314e548a961fbb08900b54.png)
9. 检查服务器响应的内容。服务器是否显式返回文件的内容？ 你是怎么知道的？

   - 显式返回文件的内容，因为返回了如下内容：
   - ![](https://img-blog.csdnimg.cn/6df3aacddaf84a7ba175e098f3c86e88.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBATUlOR2dvUw==,size_20,color_FFFFFF,t_70,g_se,x_16)
10. 现在，检查第二个HTTP GET请求的内容。 您在HTTP GET中看到了“IF-MODIFIED-SINCE:”行吗？ 如果是，“IF-MODIFIED-SINCE:”头后面包含哪些信息？

    - 是
    - ![](https://img-blog.csdnimg.cn/186f3f43f0084c2d9980c6767f7ecedc.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBATUlOR2dvUw==,size_20,color_FFFFFF,t_70,g_se,x_16)
11. 针对第二个HTTP GET，从服务器响应的HTTP状态码和短语是什么？服务器是否明确地返回文件的内容？请解释。

    - HTTP/1.1 304 Not Modified\r\n
    - 没有直接返回文件内容，因为不包含Line-based text data。
    - ![](https://img-blog.csdnimg.cn/6b1f7ef66ae04f969d815f449a2a69c3.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBATUlOR2dvUw==,size_20,color_FFFFFF,t_70,g_se,x_16)
...
12. 您的浏览器发送多少HTTP GET请求消息？哪个数据包包含了美国权利法案的消息？
    - 一个HTTP GET请求，第91个数据包。
    - ![](https://img-blog.csdnimg.cn/fd3f3ee9d05a49dbbece89559ead829d.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBATUlOR2dvUw==,size_20,color_FFFFFF,t_70,g_se,x_16)
13. 哪个数据包包含响应HTTP GET请求的状态码和短语？
    - 第91个数据包
    - ![](https://img-blog.csdnimg.cn/519740e483e84205bc5fb56bfc9e1117.png)
14. 响应中的状态码和短语是什么？
    - 200 OK
15. 需要多少包含数据的TCP段来执行单个HTTP响应和权利法案文本？
    - 4个
    - ![](https://img-blog.csdnimg.cn/96d09ca7454b41f186a9d780638e5376.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBATUlOR2dvUw==,size_20,color_FFFFFF,t_70,g_se,x_16)
...
- 启动您的浏览器。
- 启动Wireshark数据包嗅探器。
- 在浏览器中输入以下URL <http://gaia.cs.umass.edu/wireshark-labs/HTTP-wireshark-file4.html> 您的浏览器应显示包含两个图像的短HTML文件。这两个图像在基本HTML文件中被引用。也就是说，图像本身不包含在HTML文件中；相反，图像的URL包含在已下载的HTML文件中。如书中所述，您的浏览器将不得不从指定的网站中检索这些图标。我们的出版社的图标是从 [www.aw-bc.com](http://www.aw-bc.com) 网站检索的。而我们第5版（我们最喜欢的封面之一）的封面图像存储在manic.cs.umass.edu服务器。
- 停止Wireshark数据包捕获，并在display-filter-specification窗口中输入“http”，以便只显示捕获的HTTP消息。
...
16. 您的浏览器发送了几个HTTP GET请求消息？ 这些GET请求发送到哪个IP地址？
    - 3个
    - 128.119.245.12（原始网页，[http://gaia.cs.umass.edu/wireshark-labs/HTTP-wireshark-file4.html）](http://gaia.cs.umass.edu/wireshark-labs/HTTP-wireshark-file4.html%EF%BC%89)
    - 128.119.245.12（图1，[http://gaia.cs.umass.edu/pearson.png）](http://gaia.cs.umass.edu/pearson.png%EF%BC%89)
    - 178.79.137.164（图2，[http://kurose.cslash.net/8E\_cover\_small.jpg）](http://kurose.cslash.net/8E_cover_small.jpg%EF%BC%89)
    - ![](https://img-blog.csdnimg.cn/e0c24ee6b88f4a9dae094fc695f83950.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBATUlOR2dvUw==,size_20,color_FFFFFF,t_70,g_se,x_16)
17. 浏览器从两个网站串行还是并行下载了两张图片？请说明。
    - 串行，两个数据包的到达时间不一样
    - ![](https://img-blog.csdnimg.cn/61d8649fab9947b184b84bb2126c4edd.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBATUlOR2dvUw==,size_20,color_FFFFFF,t_70,g_se,x_16)
...
19. 当您的浏览器第二次发送HTTP GET消息时，HTTP GET消息中包含哪些新字段？
    ...
    - 第一次发送：
      ...
      ![](https://img-blog.csdnimg.cn/8162fe960c5e4ca99f6426569ed95bff.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBATUlOR2dvUw==,size_20,color_FFFFFF,t_70,g_se,x_16)
    - 第二次发送：

      ![](https://img-blog.csdnimg.cn/4d2a4b30bdf14b68b56aed604601b674.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBATUlOR2dvUw==,size_20,color_FFFFFF,t_70,g_se,x_16)
    - 多了`Cache-Control`，`Authorization`两个字段。

      ![](https://img-blog.csdnimg.cn/b1a3e32a0e334f4f90ca25501948f5a9.png)
